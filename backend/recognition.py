...
DB_NAME = os.getenv("DATABASE_NAME", "facerecognition_db")
USERS_COLLECTION = os.getenv("USERS_COLLECTION", "users")

if not MONGODB_URI:
    raise RuntimeError(
        "MONGODB_URI is not set. Create backend/.env from backend/.env.example "
        "and add your MongoDB connection string there."
    )
